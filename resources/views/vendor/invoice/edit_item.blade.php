...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="row">
        ...
        <form action="{{route('vinvoics.add_items',$vinvoic)}}" method="post">
          ...
          <table border="1" class="table table-bordered table-striped dataTable dtr-inline">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="{{url('vinvoics/'.$vinvoic->id.'/'.$item->id.'/edit_item')}}"><i class="fas fa-trash"></i></a></td>
                <td><a href="{{url('vinvoics/'.$vinvoic->id.'/'.$item->id.'/delete_item')}}"><i class="fas fa-edit"></i></a></td>
          ...
          <form method="post" action="{{url('vinvoics/'.$vinvoic->id.'/'.$item->id.'/update_item')}}">
            @csrf
          <table border="0">
            <tbody>
              <tr>
