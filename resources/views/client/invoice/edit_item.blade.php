...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="row">
        ...
        <form action="{{route('invoices.add_items',$invoice)}}" method="post">
          ...
          <table border="0">
            <tbody>
              <tr>
                <td>Invoice Date: </td>
                <td>
                  <input class="form-control" type="text" name="inv_date" value="{{$invoice->invoice_date}}">
                </td>
              </tr>
              <tr>
                <td>Invoice Number: </td>
                <td>
                  <input class="form-control" type="text" name="invoice_id" value="{{$invoice->id}}">
                </td>
              </tr>
              <tr>
                <td>From Date: </td>
          ...
          <table border="1" class="table table-bordered table-striped dataTable dtr-inline">
            ...
            <?php $total=0;?>
              ...
              <tr>
                ...
                <td><a href="{{url('invoices/'.$invoice->id.'/'.$item->id.'/edit_item')}}"><i class="fas fa-trash"></i></a></td>
                <td><a href="{{url('invoices/'.$invoice->id.'/'.$item->id.'/delete_item')}}"><i class="fas fa-edit"></i></a></td>
          ...
          <form method="post" action="{{url('invoices/'.$invoice->id.'/'.$item->id.'/update_item')}}">
            @csrf
          <table border="0">
            <tbody>
              <tr>
