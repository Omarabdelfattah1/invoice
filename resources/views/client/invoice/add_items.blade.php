          ...
          <table border="1" class="table table-bordered table-striped dataTable dtr-inline">
            ...
            <?php $total=0;?>
              ...
              <tr>
                ...
                <td><a href="{{url('invoices/'.$invoice->id.'/'.$item->id.'/edit_item')}}"><i class="fas fa-edit"></i></a></td>
                <td><a href="{{url('invoices/'.$invoice->id.'/'.$item->id.'/delete_item')}}"><i class="fas fa-trash"></i></a></td>
